...
from safetyObject import SafetyObject
...
def on_key_press(symbol, modifiers):
    ...
    if symbol == KEY.D:
        print("before safety object")
        safety_obj = SafetyObject(world,40)
        print("safety_obj === ",safety_obj)
        # print("x == ",safety_obj.x)
        # print("y ==",safety_obj.y)
        safety_obj.render()
    
        print("drawed the circle")

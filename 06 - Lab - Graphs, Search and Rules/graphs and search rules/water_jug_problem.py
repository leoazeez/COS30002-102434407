...
if __name__ == "__main__":
    ...
    if True:
        ...
        s = setup_jugs()
        print("s after setting up the jugs: ",s)
        # test fillling
        s = fill(s, 0)
        print("s after filling jug1 ",s)
        assert s == (5,0)

        s = fill(s, 1)
        print("s after filling jug2",s)
        #assert s == (5, 0)
        assert s == (5,3)
        ...
        # test emtpy
        s = empty(s, 0)
        print("s after emptying the first jug: ",s)
        assert s == (0, 3)
        s = empty(s, 1)
        print("s after emptying the second jug: ",s)
        #assert s == (0, 3)
        assert s == (0,0)
        # test pour / leftover actions
        s = fill(s, 0)
        print("s after filling the first jug: ",s)
        assert s == (5, 0)
        s = pour(s, 0, 1)
        print("s after pouring jug 1 in jug 2: ",s)
        #assert s == (2, 5)
        assert s ==(2,3)
        s = empty(s, 0)
        print("s after emptying jug 1: ",s)
        assert s == (0, 3)
        s = pour(s, 1, 0)
        print("s after pouring jug2 in jug1: ", s)
        #assert s == (5, 0)
        assert s==(3,0)
        s = fill(s, 1)
        print("s after filling jug2: ",s)
    ...
    if True:
        print("-----------------------------2 Solve using a pre-defined sequence of actions----------------------------")
        action_calls = {
            'fill': fill,
            'empty': empty,
            'pour': pour
        ...
        for fn, args in actions:
            print("Calling {}  with {} on {}".format(fn,args,s))
    ...
    if True:
        print("----------------------------4 Solve using sequence 2-------------------------------------")
        action_calls = {
            'fill': fill,
            'empty': empty,
            'pour': pour
        ...
        actions = [
            ...
            ('pour',[1,0]),     # transfer jug 2 to jug 1 =>(5,1)
            ('empty',[0]),      # empty jug 1             =>(0,1)
            ('pour',[1,0]),     # transfer jug 2 to jug 1 =>(1,0)
            ('fill',[1]),       #fill jug 2               =>(1,3)
            ('pour',[1,0]),     #transfer jug2 to jug 1   =>(4,0)
        ]
    ...
    if True:
        print("-----------------------------Random choice from all possible actions--------------------------------")
